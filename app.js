...
const showToast = (online)=> {
    ...
    : `<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-wifi-off text-white" viewBox="0 0 16 16">
    ...
    const faceIcon = online 
    ?`<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-emoji-smile text-white" viewBox="0 0 16 16">
    ...
    :`<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-emoji-frown text-white" viewBox="0 0 16 16">
    <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14m0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16"/>
    ...
    const html = `
    <div class="row text-center my-auto mx-3 bg-${status} shadow rounded-4">
        <div class="col-md-12 col-lg m-auto fs-2"> ${wifiIcon}</div>
        <div class="col-md-12 col-lg m-auto my-3">
            <h5>You're <b class="text-white">${text}</b> now ${faceIcon}
            </h5>
            <p class="lead text-muted">Hurray! Internet is connected.</p>
        </div>
        <a  href="#" class="col-md-12 col-lg text-dark m-auto">
...
const removeX = () => {
    const iconX = document.querySelector('.bi-x')
    iconX.addEventListener('click', ()=> main.removeChild(toast))
}
showToast(isOnline())
removeX();